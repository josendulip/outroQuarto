<template>
    <div class="date-container">
        <input type="text" readonly class="rounded-radius" @focus="showCalendar" v-model="outputDate" :placeholder="placeholder" v-bind="$attrs" :id="id+'-output'" :class="inputClass" />
        <input type="hidden" @change="inputChangeDesktop"  v-model="modelValue" :name="name" :id="id" :data-vv-as="dataVvAs" />
        <!-- <input type="hidden" @change="inputChangeDesktop" v-validate="vValidate" v-model="modelValue" :name="name" :id="id" :data-vv-as="dataVvAs" /> Tinha que tirar oo validate para n\ao dar erro -->
