    ...
    <div>   
        ...
        <hooper  v-if="photos.length != 0" :infiniteScroll="true" :itemsToShow="3" :progress="true" :autoPlay="true" :playSpeed="2000" >
            <slide  v-for="(image, index) in photos" :key="index">               
                <img :src="image.src" class="img-fluid d-block" :alt="image.caption" @click="openGallery(index)" style="object-fit:cover;">
            </slide>
                ...
                <div class="col-md-4 mt-lg-n5">
                    ...
                    <sui-card-content>
                                ...
                                <li>
                                    <span v-if="house.phone">
                                        ...
                                        <span v-else>
                                            ...
                                            <a @click.prevent="agendVisit()"><div class="ui mini label">{{ $t("view_house_schedule_view") }}</div></a>
                                        </span>
                                    </span>
                                    <del v-else class="">{{ $t("view_house_details_empty") }}</del>
                                </li>
                        ...
                        <sui-container text-align="center" v-if="user.role != 'owner'">
                            ...
                            v-if="
                                house.payment_METHOD == 'Monthly' ||
                                house.payment_METHOD == 'Quarterly' ||
                                house.payment_METHOD == 'Semiannual' ||
                                house.payment_METHOD == 'Annual'"

                            @click.prevent="agendVisit()"
                            >
                            ...
                            class="btn btn-lg text-white bg-main"
                            v-if="
                                house.payment_METHOD == 'Daily' ||
                                house.payment_METHOD == 'Weekly'"
                            @click.prevent="agendVisit()"
                            >
                    ...
                    <div class="p-3">            
                        <h4 class="text-center">Caro Usuário</h4>
                        <p>Agendamento de visita é um processo simples e rápido que consiste em 3 passos: </p>
                        <div class="ui list">
                            <div class="item">
                                1. Preencher as informações necessárias 
                            </div>
                            <div class="item">
                                2. Efetoar o pagamento e anexar o comprovativo 
                            </div>
                            <div class="item">
                                3. Efectivar o agendamento da sua visita
                            </div>
                        </div>
                        <p>Aguarda a confirmação e para a virificar, acessa menú Minhas actividades - Visitas Agendadas. </p>
                        <p>Para efeito do agendamento solicita-se uma taxa de serviço de 250 AKZ. </p>
                    </div>
