      ...
      <div class="app-container">
        <div class="h-100 container-fluid">
          <div class="h-100 no-gutters row">
                ...
                <div v-else :title="$t('register')">
                  <form @submit.prevent="register" @keydown="form.onKeydown($event)">
                    <div class="form-row">
                      ...
                      <div class="col-md-6">
                        <div class="position-relative form-group">
                          ...
                          <select v-model="form.activity" class="custom-select" name="activity" :class="{ 'is-invalid': form.errors.has('activity') }">
                            <option value="real estate agency">
                              {{ $t('placeholder_realState') }}
                            </option>
                            <option value="Intermediate">
                              {{ $t('placeholder_intermediate') }}
                            </option>
                            <option value="Private">
                              {{ $t('placeholder_private') }}
                            </option>
                          </select>
                      ...
                      <div class="col-md-6">
                        <div class="position-relative form-group">
                          <label for="confirm_password"><span class="text-danger">*</span>{{ $t("confirm_password") }}</label>
                    ...
                    <div class="mt-3 position-relative form-check">
                      <input id="exampleCheck" name="check" type="checkbox" class="form-check-input">
                      <label for="exampleCheck" class="form-check-label">{{ $t("register_terms") }}
                        <a href="javascript:void(0);">{{ $t("register_link_phrase") }}</a>.</label>
                    </div>
                    <div class="divider row" />
                    <div class="mt-4 d-flex align-items-center">
                      <h5 class="mb-0">
                        {{ $t("register_has_acount") }}
                        <router-link :to="{ name: 'login' }" active-class="active" class="text-primary">{{ $t("goTo__login_link") }}</router-link>
                      </h5>
                      <div class="ml-auto">
                        <v-button :loading="form.busy" class="badge-pill btn-shadow btn-hover-shine btn bg-main">
                          {{ $t("register") }}
                        </v-button>
                      </div>
                    </div>
            ...
            <div class="d-lg-flex d-xs-none col-lg-5 bg-main">
                  ...
                  <sui-list>
                    <a is="sui-list-item" class="d-flex align-items-center text-white ">
                      ...
                      <sui-list-content>
                        ...
                        <sui-list-description>{{ $t("announce_list1_2") }}</sui-list-description>
                      </sui-list-content>
                    </a>
                    <a is="sui-list-item" class="d-flex align-items-center text-white ">
                      ...
                      <sui-list-content>
                        ...
                        <sui-list-description>{{ $t("announce_list2_2") }}</sui-list-description>
                      </sui-list-content>
                    </a>
                    <a is="sui-list-item" class="d-flex align-items-center text-white ">
                      ...
                      <sui-list-content>
                        ...
                        <sui-list-description>{{ $t("announce_list3_2") }}
